...
\abr{CRP}{Challenge-Response Pair}
\abr{CTIS}{Cyber Threat Information Sharing}
\abr{DAA}{Designated Accrediting Authority}
\abr{Dapp}{Decentralized Application}
\abr{DIAM}{Decentralized Identity and Access Management}
\abr{EU}{European Union}
...
\abr{IETF}{International Engineering Task Force}
