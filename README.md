...
> [!NOTE]
> This repository is practically a mirror to https://github.com/arminveres/bachelor-thesis-23, more
> specifically the `feat/portability` branch. In case of issues, refer there first before creating a new issue.
